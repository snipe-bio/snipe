    ...
    def process_sample(self, sample_sig, predict_extra_folds: Optional[List[int]] = None, advanced: Optional[bool] = False) -> Dict[str, Any]:
        ...
        if self.repetitive_aware_flag:
            ...
            genome_stats.update({
                ...
                "Genomic repfree k-mers mean abundance": abundance_based_sample_genome_stats["total_abundance"] / self.reference_without_repeats,
        ...
        if self.amplicon_sig is not None:
            ...
            if self.repetitive_aware_flag:
                ...
                amplicon_stats["Amplicon repfree k-mers mean abundance"] = abundance_based_sample_amplicon_stats["total_abundance"] / self.amplicon_without_repeats
